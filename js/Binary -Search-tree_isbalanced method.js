...
class Binary_search_tree {
    ...
    isbalanced() {
        // rootL to store the height/depth of the root's left child
        // rootR to store the height/depth of the root's Right child
        // diff to store the differnce between rootL - rootR
        let rootL, rootR, diff;
        ...
        //to recurse the left child of the root
        rootL = recursionhelper(this.root.left)
        //to recurse the right child of the root
        rootR = recursionhelper(this.root.right)
        //differnce
        diff = Math.abs(rootL - rootR);
